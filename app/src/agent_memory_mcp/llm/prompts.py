...
4. Определи, относится ли чат к РАБОЧЕМУ проекту, и к какому. Название чата \
часто уже содержит название проекта — это главный сигнал, содержимое уточняет. \
"project" = название проекта (нормализованное, одинаковое для всех чатов одного \
проекта) или "" если это личный/нерабочий чат. "is_work" = true/false.

Отвечай строго в JSON:
{
  "domain_type": "<string>",
  "project": "<string|пусто>",
  "is_work": <bool>,
  "entity_types": [
